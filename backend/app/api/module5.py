...
from app.services import module5_service

router = APIRouter(prefix="/api/module5", tags=["Module 5 — Product Interaction Analysis"])
...
def get_interaction_analysis(
    ...
    """
    Retrieve full Module 5 product interaction analysis results for a completed AI job.
    Pure read-only operation; does NOT trigger analysis engine execution.
    """
    return module5_service.get_module5_analysis(db, job_id)
